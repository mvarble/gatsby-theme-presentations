...
function useDeckStates(ref, fragmentsBySlide) {
  // step 0: interface with the deck state
  var _useDeck = (0, _useDeck3["default"])(function (deck) {
    return [deck.initializeStates, deck.ready];
  }, _shallow["default"]),
      _useDeck2 = _slicedToArray(_useDeck, 2),
      initializeStates = _useDeck2[0],
      ready = _useDeck2[1]; // step 1: populate these objects on changes
