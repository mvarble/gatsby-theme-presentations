...
var _gatsbyPluginMdxConfig = require("@mvarble/gatsby-plugin-mdx-config");
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            _node$frontmatter = node.frontmatter, title = _node$frontmatter.title, slug = _node$frontmatter.slug, date = _node$frontmatter.date, maybeWidth = _node$frontmatter.width, maybeHeight = _node$frontmatter.height, maybeDescription = _node$frontmatter.description; // revert to default dimensions if not provided

            width = typeof maybeWidth === 'number' && (0, _utils.isNonnegativeInteger)(maybeWidth) ? maybeWidth : 960;
          ...
          case 19:
            ...
            presContentString = JSON.stringify(presContent);
            presNode = _objectSpread({
              id: createNodeId("".concat(node.id, " >>> Presentation")),
              children: [],
              parent: node.id,
              internal: {
